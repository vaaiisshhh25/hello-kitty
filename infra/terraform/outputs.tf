...
output "aws_lambda_hello_kitty_function_vaishnavi25_function_url" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_url
  sensitive = false
}


output "aws_lambda_hello_kitty_function_vaishnavi25_invoke_arn" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.invoke_arn
  sensitive = false
}


output "aws_lambda_hello_kitty_function_vaishnavi25_function_arn" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_arn
  sensitive = false
}


output "aws_lambda_hello_kitty_function_vaishnavi25_function_name" {
  value = module.appcd_00a20b0a-2ec0-5bdc-a08d-65a85dc81d5b.function_name
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_vaishnavi25_arn" {
  value = module.appcd_b71fd16c-797e-5a95-8e1b-ab22f1e34f43.arn
  sensitive = false
}


output "aws_iam_role_hello_kitty_role_vaishnavi25_name" {
